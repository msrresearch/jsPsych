  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append('<div style=""><p>Das Experiment wird im Vollbildmodus gestartet, sobald du "OK" dr\u00fcckst</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">OK</button></div>');
