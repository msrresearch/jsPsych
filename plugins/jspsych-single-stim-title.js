...
jsPsych.plugins["single-stim-title"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('single-stim-title', 'stimulus', 'image', function(t){ return !t.is_html || t.is_html == 'undefined'});

  plugin.info = {
    name: 'single-stim-title',
    description: '',
    parameters: {
      stimulus: {
